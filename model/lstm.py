...
# import tensorflow.contrib.rnn.RNNCell
# from tensorflow.nn import rnn_cell
# from tensorflow.nn.rnn import rnn_cell
# from  tensorflow.contrib.rnn import RNNCell
# from tensorflow.contrib.rnn.python.ops import rnn
from tensorflow.python.ops.rnn import static_rnn as rnn
...
class TextLSTM(object):
    ...
    TODO: Also try a bidirectional RNN.
    TODO: Consider using 'EmbeddingWrapper'.
    TODO: NEVER use 'tf.Variable' directly!
    TODO: Use 'variable_scope' instead of 'name_scope'.
    """
    ...
    def __init__(self, sequence_length, vocab_size, embedding_size, hidden_size,
        ...
        print(type(sequence_length), type(embedded_words))
        ...
        with tf.name_scope("loss"):
            self.losses = tf.nn.softmax_cross_entropy_with_logits_v2(logits = self.scores,
                                                                  labels = self.input_y)
