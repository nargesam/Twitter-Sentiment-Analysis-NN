...
VALID_SIZE = 1000    #test size 
FULL_TRAIN_SIZE = 7885+7885 #sum of pos and neg tweets  2385 + 7635
SMALL_TRAIN_SIZE = 200000 # we don't need this
...
def main(argv):
    ...
    try:
        ...
        sys.exit(2)
    for opt, arg in opts:
        # : Warn when not using full subset!
        if opt in ("-f", "--full"):
